...
import org.radiowar.taginfo.pojo.mifare.MifareKey;
...
//	};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.titleText.setText("Read Card");
        
        KeyInfoDao dao = new KeyInfoDao(this);
        List<Key> keyList = dao.getAllKeyInfo();
        defaultKeys = new String[keyList.size()];
        for(int i=0;i<keyList.size();i++){
        	defaultKeys[i]=keyList.get(i).getKeyValue();
        }
